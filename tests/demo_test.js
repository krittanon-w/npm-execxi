...
var res1 = execxi.executeArray(commands, {"chained": false});
...
var res2 = execxi.executeArray(commands, {"chained": true});
...
var res3 = execxi.executeArray(commands, {"chained": true, "exitSuccess":[0,1]});
